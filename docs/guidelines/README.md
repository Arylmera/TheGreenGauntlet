...
Terse, principle-level conventions for this stack. Not a textbook — pair with Context7 / source code for depth.

One file per concern. Keep entries to bullet points. If something stops being true, delete it, don't append.
...
- [git.md](git.md) — branch, commit, PR conventions
