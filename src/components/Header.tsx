...
import { Clouds } from './mario/Clouds';
...
export function Header({ updatedAt, theme, onSetTheme, soundEnabled, onToggleSound }: Props) {
  ...
  return (
    <header className="relative bg-surface-white dark:bg-dark-card border-b border-line-light dark:border-dark-line">
      {isMario && <Clouds />}
      <div className="relative max-w-screen-2xl mx-auto px-4 sm:px-6 lg:px-8 py-3 sm:py-4 lg:py-5 flex items-center justify-between gap-3 sm:gap-6">
        <div className="flex items-center gap-3 sm:gap-4 min-w-0">
          ...
          <div className="flex flex-col min-w-0">
            <h1 className={`text-lg sm:text-xl lg:text-page-title text-ink-black dark:text-dark-text leading-none truncate ${isMario ? 'q-block' : ''}`}>
              The Green Gauntlet
            </h1>
