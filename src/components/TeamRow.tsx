...
const MARIO_CELL = {
  ...
  IL: 'hidden lg:table-cell px-2 sm:px-4 py-3 sm:py-4 text-right num text-xl text-[color:var(--mario-ink-soft)] w-36',
  MARIO: 'hidden lg:table-cell px-2 sm:px-4 py-3 sm:py-4 text-right num text-xl w-20',
  CROKINOLE: 'hidden lg:table-cell px-2 sm:px-4 py-3 sm:py-4 text-right num text-xl w-24',
